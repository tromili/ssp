...
public class MainActivity2 extends ActionBarActivity implements android.support.v7.app.ActionBar.TabListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tab friendstab = getSupportActionBar().newTab().setText("Presentación").setTabListener(this);
        Tab publicprofiletab = getSupportActionBar().newTab().setText("Mis Cotizaciones").setTabListener(this);
        Tab communitytab = getSupportActionBar().newTab().setText("Nuevo Registro").setTabListener(this);
